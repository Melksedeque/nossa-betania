    ...
    <section className="py-16 relative">
       <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-white mb-2 flex items-center justify-center gap-2">
            <span className="text-orange-500">🏆</span> Hall da Fama <span className="text-orange-500">🏆</span>
          </h2>
       ...
       <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row items-end justify-center gap-4 mb-12">
             {/* 2nd Place */}
             <div className="order-2 md:order-1 flex-1 w-full bg-slate-800/50 border border-slate-700 rounded-xl p-6 flex flex-col items-center text-center transform hover:scale-105 transition-transform duration-300 relative mt-8 md:mt-0">
             ...
             {/* 3rd Place */}
             <div className="order-3 flex-1 w-full bg-slate-800/50 border border-slate-700 rounded-xl p-6 flex flex-col items-center text-center transform hover:scale-105 transition-transform duration-300 relative">
                <div className="absolute -top-4 text-3xl">🥉</div>
                <div className="w-20 h-20 rounded-full border-2 border-slate-600 mb-3 overflow-hidden relative bg-slate-700">
